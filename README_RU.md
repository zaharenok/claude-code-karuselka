...
- **Генерация видео**: Seedance 1.5 Pro (ByteDance), Grok Video, fal.ai
- **Хранилище**: Kie.ai, S3, локальное
- **Интеграция с Hermes**: Слэш-команды, delegate_task оркестрация, MCP сервер
- **CLI**: Командная строка для ручного создания каруселей
